...
import 'package:rudo_wealth_test/application/presentation/utils/validators/validation_textfield.dart';
    ...
    return Padding(
      ...
      child: TextFormField(
        ...
        decoration: InputDecoration(
          ...
          errorMaxLines: 3,
          hintStyle:
              Theme.of(context).textTheme.displaySmall?.copyWith(color: kgrey),
